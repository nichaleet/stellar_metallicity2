...
;    endif else pi[2].limits = [40.,400.]; [30.,200.]
   ...
   ; maxnloop = 150
    ...
    openw,copynum,'/scr2/nichal/workspace4/sps_fit/logsps/sps_fit_cl0024alpha'+copynum+'.log',/append
    printf,copynum, '* * * * * * * * * * * * * * * * * * * *'
...
;    wfitalpha = widget_button(wprepbase, value='Fit alpha', uvalue='fitalpha', uname='fitalpha', tab_mode=1, xsize=85)
    ...
    wfitomg = widget_button(wdefaultsbase,value='Fit N Mg',uvalue='fitomg',uname='fitomg',tab_mode=1,xsize=100)
