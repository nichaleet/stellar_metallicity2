...
common get_sps_alpha, element
   ...
   choi = mrdfits('/scr2/nichal/workspace4/sps_fit/data/choi/ages/sps_fit01.fits.gz',1,/silent)
   redshift = choi[0].zfit
   obslambda = choi[0].lambda
   dlam = choi[0].dlam  ;already sigma, not fwhm
  ...
  ;Mg region
   ...
   ;;;;;;;;;;;;;;;;;;;;;;;;;;;;
   ;wavelength range
   w = where(obslambda/(1.+redshift) lt 3650. or obslambda/(1.+redshift) gt 5800.,c)
   if c gt 0 then mask[w]=0
   ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
   mask[0:4] = 0
   mask[nwl-5:nwl-1] = 0
