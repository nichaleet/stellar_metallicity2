...
;    pi[1].limits = [min(spsage),4.0]
   ...
   ;;make the initial guesses unfix but within limits except redshift
    ...
    while nloop lt maxnloop do begin
        ...
        bkpt = slatec_splinefit(restlambda[won], science.contdiv[won]/spsbestfit[won], coeff, invvar=science.contdivivar[won]*(spsbestfit[won])^2, bkspace=100, upper=3, lower=3, /silent)
