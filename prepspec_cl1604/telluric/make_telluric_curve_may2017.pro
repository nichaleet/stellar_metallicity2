pro make_telluric_curve_may2017
   obsfile = '/scr2/nichal/WMKO/LRIS/2018may_cl1604/reduce_wolf1346_400grating/spredux1d/elsr180512_0046r_GD140.spec'
   ...
   tellstart = [6540.,7590.,9300]
   tellend   = [6580.,7680.,9600]
   ...
   tellstr = {wl:obs.wl,tell:tell/confit,tellerr:tellerr/confit}
