pro shortwl_ana
   ...
   dage = alog10(short.age/iage)
   dageu = alog10(short.ageupper/iage)
   dagel = alog10(short.agelower/iage)
   dz  = short.feh-izmet 
   ...
   !p.font=0
   !p.charsize=2
   psname='plots/shortwl_deltaage_sn_fixage.eps'
   ...
   psname='plots/shortwl_deltazmet_sn_fixage.eps'
   device, filename = psname,xsize = 30,ysize = 8, $
                xoffset = 0,yoffset = 0,scale_factor = 1.0,/encapsulated,/color
      !p.multi = [0,3,1]
      for i=0,n_elements(age_uniq)-1 do begin
