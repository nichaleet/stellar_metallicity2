...
;    endif else pi[2].limits = [40.,400.]; [30.,200.]
   ...
   ;;make the initial guesses unfix but within limits except redshift
    ...
    openw,1,'/scr2/nichal/workspace4/test_shortwl/logsps/sps_fit_testfullwl.log',/append
    printf,1, '* * * * * * * * * * * * * * * * * * * *'
    printf,1,systime()
...
pro sps_fit::getscience, files=files
    ...
    if ~file_test(sciencefits) then begin
        ...
        for i=0,nspec-1 do begin
            ...
            science.contdiv = data.contdivfulll
...
pro sps_fit_testfullwl
    common mask_in, mask_in
    mask = 'test_fullwl'
    mask_in = mask
    directory = '/scr2/nichal/workspace4/testshortwl/mockdata/'
