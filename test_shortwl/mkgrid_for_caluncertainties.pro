...
common get_sps, dlam, dataivar, datalam, wonfit, contmask, normalize,rest
   ...
   ;get the obs setting    
   sample = mrdfits('/scr2/nichal/workspace4/test_shortwl/mockdata/mockdeimos_cl1604_zmetm0d05_1gyr_sn10_1.fits',1)
  ...
  ;Mg region
   readcol,'/scr2/nichal/workspace2/sps_fit/lick_indices.txt',indnum,indbandstart,$
           indbandend,bluecontstart,bluecontend,redcontstart,redcontend,junk,indname,$
   ...
   won = where(sample.fitmask eq 1, con)
   wonfit = won
...
pro mkgrid_for_caluncertainties
   ...
   spec_arr = make_spec(grid_feh,grid_age,/short)
   mwrfits,spec_arr,'sspdegen_gridspec_shortwl.fits',/silent,/create
   spec_arr = make_spec(grid_feh,grid_age,/full)
   mwrfits,spec_arr,'sspdegen_gridspec_fullwl.fits',/silent,/create
