pro plotspec_cl0024_jobtalk,objnumarr,nameadd,lambdalim=lambdalim,ylim=ylim,nofit=nofit,idealmask=idealmask
;e.g. plotspec_cl0024_jobtalk,[18],'jobtalk'
sciall = mrdfits('/scr2/nichal/workspace4/sps_fit/data/cl0024/sps_fit03.fits.gz',1)

nspec = n_elements(objnumarr)
...
psname = 'panel_spec_cl0024_'+nameadd+'.eps'
set_plot,'ps'
