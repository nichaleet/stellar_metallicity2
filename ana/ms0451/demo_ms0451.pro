pro demo_ms0451
   ...
   device, filename = psname,xsize = 18,ysize = 8, $
      ...
      plothist,sci.oiiew,bin=2.5,xrange=[-7.5,25],xtitle='OII EW',ytitle='Number of galaxies',/fill,fcolor=fsc_color('gray'),xtickformat='(A1)',yrange=[0,90],position=[0.1,0.15,0.48,0.95]
      ...
      !p.charsize=1
      xyouts,5,80,'MS0451',charsize=1.2
      sunsym = sunsymbol()
      plothist,sci.logmstar,xrange=[9,12],xtitle='log[M!L*!N/M!N'+sunsym+'!N]',/fill,fcolor=fsc_color('gray'),yrange=[0,90],bin=0.3,position=[0.57,0.15,0.95,0.95],xtickformat='(A1)'
